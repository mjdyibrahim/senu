...
def receive_txt(sender_number: str, msg: str):
    msg_queue.put((msg, sender_number))

def receive_audio(sender_number: str, media: str):
...
# Initialize your singletons
message_queue_singleton = MessageQueueSingleton()
audio_queue_singleton = AudioQueueSingleton()
